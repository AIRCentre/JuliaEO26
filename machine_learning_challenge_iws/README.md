...
- A readme file containing precise instructions on how to set up the environment and run the code
- The final csv output file with the relevant performance metrics
